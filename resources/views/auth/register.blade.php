                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ruc" type="text" class="form-control @error('ruc') is-invalid @enderror" name="ruc" value="{{ old('ruc') }}" required autocomplete="ruc">
                        ...
                        <div class="form-group row">
                            <label for="partida_registral" class="col-md-4 col-form-label text-md-right">{{ __('Partida Registral') }}</label>

                            <div class="col-md-6">
                                <input id="partida_registral" type="text" class="form-control @error('partida_registral') is-invalid @enderror" name="partida_registral" value="{{ old('partida_registral') }}" required autocomplete="partida_registral">

                                @error('partida_registral')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        ...
                        <div class="form-group row">
                            <label for="type_id" class="col-md-4 col-form-label text-md-right">{{ __('¿Que tipo de empresa eres?') }}</label>
