		...
		<div class="container">
			...
			<div v-if="data_offers.length > 0">
				<div id="carousel-business-products">
					<!-- Carousel Card -->
					<div class="container" v-for="(data_offer, index) in data_offers" :key="index">
						<div class="card">
							...
							<div class="card-body">
								...
								<p class="product-category">
									Categoria: <span class="badge">{{ data_offer.offer_category[0].name }}</span>
								</p>
								<button class="btn btn-outline-success" data-toggle="modal" :data-target="'#modalProductDetail-'+index">
									Ver detalle
								</button>
							</div>
						</div>
				...
				<div v-for="(data_offer, index) in data_offers" :key="index">
					<div class="modal fade" :id="'modalProductDetail-'+index" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="product-detail-title modal-title">{{data_offer.offer.title}}</h5>
								...
								<div class="modal-body">
									<div class="row">
										<div class="col-md-6">
											<a :href="data_offer.offer.image_url" target="_blank">
												<img :src="data_offer.offer.image_url" class="product-detail-image card-img-top">
											</a>
										</div>
										<div class="col-md-6">
											<div class="content-product-detail">
												...
												<div class="product-detail-certifications-list" style="margin: 5px 0px 16px;">
													Certificaciones:
													<div v-if="data_offer.certifications.length > 0">
			...
			<div v-else>
				<div class="container p-5 text-center">
					<p class="h3" style="color: rgb(107, 107, 107); margin-bottom: 20px;">Aun no hay ofertas disponibles</p>
				</div>
			</div>
		</div>
