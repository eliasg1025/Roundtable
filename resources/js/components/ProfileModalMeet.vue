<template>
	<div>
		...
		<div v-if="can_view_data(data_meeting.state.id)">
			<!--Modal-->
			<div class="modal fade" :id="'previewInfoBusiness-'+data_meeting.meeting.id+'-'+type" tabindex="-1" role="dialog" :aria-labelledby="'previewInfoBusinessLabel-'+data_meeting.meeting.id" aria-hidden="true">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<fieldset>
											...
											<div class="container p-3">
												<div v-for="avalible_time in avalible_times" :key="avalible_time.id" class="row pb-2 mb-2" style="border-bottom: 1px solid #ececec;">
													<div class="col">
														<div v-for="day in avalible_time.daysOfWeek" :key="day.id" style="display: inline-block;" class="mb-1">
															<span v-if="day.value" class="badge badge-info">{{ day.name }}</span>&nbsp;
														</div>
														<br>
